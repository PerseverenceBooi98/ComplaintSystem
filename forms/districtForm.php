...
<head>
    ...
    <title>District Complaint Form - NW Complaint Management System</title>
...
<body>
    ...
    <div class="container mt-5">
        <h2>District Complaint Form</h2>
        <form action="../submit_complaint.php" method="post" id="complaintForm">
            <input type="hidden" name="complaint_type" value="district">
            <input type="hidden" name="jurisdiction" value="district">
            <div class="mb-3">
