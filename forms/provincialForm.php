...
<head>
    ...
    <title>Provincial Complaint Form - NW Complaint Management System</title>
...
<body>
    ...
    <div class="container mt-5">
        <h2>Provincial Complaint Form</h2>
        <form action="../submit_complaint.php" method="post" id="complaintForm">
            <input type="hidden" name="complaint_type" value="provincial">
            <input type="hidden" name="jurisdiction" value="provincial">
            <div class="mb-3">
            ...
            <div class="mb-3">
                <label for="department" class="form-label">Provincial Department</label>
